#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\Pau Allende\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.287\\out\\buildHook\\index.js').default({tool: 'astro'}); } catch(cjsError) { try { import('file:///c:/Users/Pau%20Allende/.vscode/extensions/wallabyjs.console-ninja-1.0.287/out/buildHook/index.js').then(m => m.default.default({tool: 'astro'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
